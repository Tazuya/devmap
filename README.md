...
- [**Карта развития Back-end разработчика:**](#Карта-развития-back-end-разработчика-)
    ...
    - [x] [Серверные языки программирования](#Серверные-языки-программирования-)
    ...
    - [x] [Устройство веб-серверов и способы взаимодействия](#Устройство-веб-серверов-и-способы-взаимодействия-)
...
- [x] Статьи:
    - [x] [Структуры данных для самых маленьких](https://habrahabr.ru/post/310794/)
...
- [x] Усвоить понятия:
    - [x] Абстракция данных
    - [x] Функция высшего порядка
    - [x] Чистые функции
    - [x] Рекурсия
    - [x] Замыкания
    - [x] Неизменяемый объект

- [x] Статьи:
    - [x] [Функциональное программирование для всех (habrahabr)](https://habrahabr.ru/post/142351/)
    - [x] [Умение видеть абстракции (habrahabr)](https://habrahabr.ru/company/infopulse/blog/185144/)
...
- [x] Усвоить понятия:
    ...
    - [x] Базовые принципы разработки ПО в VCS
    - [x] Ежедневный цикл работы
...
- [x] Виды тестов:
    - [x] Блочное тестирование (модульное, unit testing)
    - [x] Интеграционное тестирование
    - [x] Системное тестирование

- [x] Изучить методологии:
    - [x] Разработка через тестирование (TDD)
    - [x] разработка, основанная на функционировании (BDD)

- [x] Статьи:
    - [x] [Виды тестирования и подходы к их применению (habrahabr)](https://habrahabr.ru/post/81226/)
    - [x] [Test-Driven Development — телега или лошадь? (habrahabr)](https://habrahabr.ru/post/206828/)
...
- [x] Уязвимости:
    - [x] SQL-инъекция
    - [x] Межсайтовый скриптинг или XSS
    - [x] Демонстрация ошибок пользователю
    - [x] Доступность данных о характеристиках системы пользователю
    - [x] Инъекция через загрузку файлов
    - [x] E-mail-инъекция
    - [x] Кража сессии
...
- [x] Статья:
    - [x] [Top 5 уязвимостей PHP безопасности](http://php-hack.ru/php_mysql/top_5_uyazvimostej_php_bezopasnosti/)
...
- [x] Познакомиться cо слелующими типами паттернов:
    - [x] Порождающие шаблоны проектирования
    - [x] Структурные шаблоны проектирования
    - [x] Поведенческие шаблоны проектирования
...
- [x] Статьи:
    - [x] [Регулярные выражения (wikipedia)](https://ru.wikipedia.org/wiki/%D0%A0%D0%B5%D0%B3%D1%83%D0%BB%D1%8F%D1%80%D0%BD%D1%8B%D0%B5_%D0%B2%D1%8B%D1%80%D0%B0%D0%B6%D0%B5%D0%BD%D0%B8%D1%8F)
    - [x] [Жадные и ленивые квантификаторы (learn.javascript)](https://learn.javascript.ru/regexp-greedy-and-lazy)
...
- [x] Статьи:
    - [x] [Проектирование баз данных (wikipedia)](https://ru.wikipedia.org/wiki/%D0%9F%D1%80%D0%BE%D0%B5%D0%BA%D1%82%D0%B8%D1%80%D0%BE%D0%B2%D0%B0%D0%BD%D0%B8%D0%B5_%D0%B1%D0%B0%D0%B7_%D0%B4%D0%B0%D0%BD%D0%BD%D1%8B%D1%85)
    - [x] [Нормальная форма (wikipedia)](https://ru.wikipedia.org/wiki/%D0%9D%D0%BE%D1%80%D0%BC%D0%B0%D0%BB%D1%8C%D0%BD%D0%B0%D1%8F_%D1%84%D0%BE%D1%80%D0%BC%D0%B0)
    - [x] [Нормализация отношений. Шесть нормальных форм (habrahabr)](https://habrahabr.ru/post/254773/)
